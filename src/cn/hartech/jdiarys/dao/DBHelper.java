 ...
 *   2，如果目标数据库文件不存在，自动创建该文件，并创建表（onCreate）。（记得申请APP写SDCard卡权限）
...
public class DBHelper extends SQLiteOpenHelper {
	...
	*/
	public DBHelper(Context context) {
		...
		super(context, MyUtility.getAppFolder() + Constant.DB_FILE_NAME, null,
				VERSION);
	...
	public void onCreate(SQLiteDatabase database) {
		...
		String createTableSQL = "create table diary_content"
				...
				+ "content, is_favor, tags, modify_time, modify_count, is_delete)";
